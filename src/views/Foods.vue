<template>
  <div>
    ...
    <b-row>
      <b-col cols="12">
        <div class="feed overflow-auto">  
          ...
          <div>
            <b-table table-variant="light" small :fields="tableFields" :items="userFoods" responsive="sm" striped hover>
    ...
    <b-modal v-model="modalShow" ref="my-modal" hide-footer title="Feel" @hide="resetForm()">
      <div class="d-block text-center">
        <h3>Hello!</h3>
      </div>
      <AddForm @close_modal="modalShow = !modalShow" :toEditID="selectedFoodId"/>
    </b-modal>
  </div>
</template>
